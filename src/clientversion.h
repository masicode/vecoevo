...
//! These need to be macros, as clientversion.cpp's and veco*-res.rc's voodoo requires it
...
/**
 * vecod-res.rc includes this file, but it cannot cope with real c++ code.
