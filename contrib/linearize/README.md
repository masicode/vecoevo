# Linearize
Construct a linear, no-fork, best version of the Veco blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install veco_hash

https://github.com/vecopay/veco_hash
...
JSON-RPC server. Running `vecod` or `veco-qt -server` will be sufficient.
...
* `input`: vecod blocks/ directory containing blkNNNNN.dat
